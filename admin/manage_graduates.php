...
if ($search !== '') {
    $stmt = db()->prepare('SELECT * FROM graduates WHERE matric_number LIKE ? OR ref_number LIKE ? ORDER BY id DESC');
    ...
    <div class="container">
        ...
        <div class="panel">
            <form method="get" action="manage_graduates.php" class="search-row">
                <input name="search" type="text" placeholder="Search by matric or reference number" value="<?= e($search) ?>">
            ...
            <div class="table-wrap">
                <table>
                    ...
                    <tbody>
                        ...
                        <?php endforeach; ?>
                        <?php if (!$graduates): ?>
                            <tr><td colspan="9" class="empty">No graduate records found.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
